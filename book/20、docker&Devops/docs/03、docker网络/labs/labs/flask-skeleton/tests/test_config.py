...
from skeleton.server import app


class TestDevelopmentConfig(TestCase):

    def create_app(self):
        app.config.from_object('skeleton.server.config.DevelopmentConfig')
        return app
...
class TestProductionConfig(TestCase):
    ...
    def create_app(self):
        app.config.from_object('skeleton.server.config.ProductionConfig')
        return app

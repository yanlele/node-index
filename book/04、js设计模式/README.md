...
- [第四篇、行为型设计模式](./04篇、行为型设计模式/README.md#class04)
    ...
    - [23、中介者模式](./04篇、行为型设计模式/22-26章节.md#class04-22)
    - [24、备忘录模式](./04篇、行为型设计模式/22-26章节.md#class04-22)
    - [25、迭代器模式](./04篇、行为型设计模式/22-26章节.md#class04-22)
    - [26、解释器](./04篇、行为型设计模式/22-26章节.md#class04-22)
